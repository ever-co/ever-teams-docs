...
export const Plan = ({ name, amount, period, alt, badge, featured, features }) => (
  <div className={featured ? `${styles.plan} ${styles.planFeatured}` : styles.plan}>
    ...
    <div className={styles.planAlt}>{alt}</div>
...
Cloud plans are tiered by number of active users. Prices are in USD and taxes
may apply; one purchase covers both the Platform and the Kit.
...
<div className={styles.plans}>
  <Plan
    ...
    amount="Free"
    period=""
    alt="For smaller teams organizing their work"
    features={["1 user", "1 active user", "Product support"]}
  />
  <Plan
    name="Premium"
    amount="$15"
    ...
    features={[
      ...
      "5 active users, $3 per additional user",
      "Unlimited teams, tasks, and projects",
      "All Kit components",
    ]}
  />
  <Plan
    ...
    features={[
      "Everything in Starter",
      "10 active users, $10 per additional user",
      "Unlimited teams, tasks, and projects",
      "All Kit components",
    ]}
  />
...
These tiers reflect [ever.team/pricing](https://ever.team/pricing) at the time of writing. The pricing page is always the source of truth for current plans and limits.
...
Plan, resource and status details on this page are sourced from{" "}
